...
//	
	...
	OLED_Clear();OLED_ShowString(0,0,"Connect MQTT Server Success",16);DelayXms(500);
...
{
		OLED_Clear();
		OLED_ShowCHinese(0,0,1);//ÎÂ
		OLED_ShowCHinese(18,0,2);//¶È
		OLED_ShowCHinese(36,0,0);//£º
		OLED_ShowCHinese(72,0,3);//¡æ
		
		OLED_ShowCHinese(0,3,4);//Êª
		OLED_ShowCHinese(18,3,5);//¶È
		OLED_ShowCHinese(36,3,0);//£º
		OLED_ShowString(72,3,"%",16);//%
		
		OLED_ShowCHinese(0,6,6);//Ì¨
		OLED_ShowCHinese(18,6,7);//µÆ
		OLED_ShowCHinese(36,6,0);//£º
}
...
void Hardware_Init(void)
{
	...
	//UsartPrintf(USART_DEBUG, " Hardware init OK\r\n");
	OLED_Clear();
	OLED_ShowString(0,0,"Hardware init OK",16);DelayMs(1000);
